...
function handleTool(name,args){
  ...
  if(name==="get_sign_in_logs"){
    ...
    var logPath="/auditLogs/signIns?$top="+lim2+"&$orderby=createdDateTime desc&$select=createdDateTime,userDisplayName,userPrincipalName,appDisplayName,ipAddress,status,location";
    if(args.user_id)logPath+="&$filter=userPrincipalName%20eq%20%27"+args.user_id+"%27";
